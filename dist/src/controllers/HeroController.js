...
const HeroesServices_1 = require("../services/HeroesServices");
class HeroController {
    constructor() {
        this.heroesService = new HeroesServices_1.HeroesService();
    }
    async getAllHeroesPaginated(req, res, next) {
        try {
    ...
    async getHeroByName(req, res, next) {
        try {
